...
if (test-path "C:\Program Files\Microsoft Visual Studio\2022\Community") { $pg_versions = @('12', '13', '14', '15', '16') }
if (test-path "C:\Program Files\Microsoft Visual Studio\18\Community") { $pg_versions = @('15', '16') }
